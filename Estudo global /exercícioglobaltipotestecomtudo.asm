#progama comprimenta o utilizador;pede o nome;introduz dois numeros float e faz diferentes operações e no final escolhe uma área que queira fazer
.data
cump: .asciiz"Boas,"
...
.text #printar uma string e escrever outra string: ver video jo youtubes

#cumprimentar/introduz nome
#pede_nome
li $v0,4
la $a0,introduznome
syscall
